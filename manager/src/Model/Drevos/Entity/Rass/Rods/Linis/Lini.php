...
class Lini
{
    ...
    /**
     * @var StanMat
     * @ORM\ManyToOne(targetEntity="App\Model\Drevos\Entity\Rass\Rods\StranMats\StanMat", inversedBy="linias")
     * @ORM\JoinColumn(name="stranmat_id", referencedColumnName="id", nullable=false)
     */
    private $stranmat;
    ...
    public function getStranmat(): StanMat
    {
        return $this->stranmat;
    }


    public function addWetka(
        WetkaId $id,
        string $nameW,
        int $sortWetka
    ): void {
