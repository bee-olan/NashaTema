...
class VetkaBr
{
    ...
    /**
     * @var VetkaBr|null
     * @ORM\ManyToOne(targetEntity="VetkaBr")
     * @ORM\JoinColumn(name="rodit_vet_id", referencedColumnName="id", nullable=true, onDelete="SET NULL")
     */
    private $roditVet;  // родитель?LiniBr $roditBr
                                ...
                                ): void
    {
        ...
        $this->nomers->add(new NomerBr($this, $id, $nomBr,
                                        $god, $sortNom, $title, $parentn));
    }
                            ...
                            ): void
    {
        ...
        throw new \DomainException('nomer is not found.editNomerBr');
    }
    ...
    public function removeNomerBr(NomerBrId $id): void
    {
        ...
        throw new \DomainException('NomerBr is not found. removeNomerBr');
    }
...
// равно Ли Имя
     ...
     * @return VetkaBr|null
     */
    public function getRoditVet(): ?VetkaBr
    {
        return $this->roditVet;
    }
